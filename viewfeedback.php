...
td{
  ...
  text-align:center;
    ...
    <body>
        ...
        <center><h1 style="color:orange">FEEDBACK DETAILS</h1></center>
        ...
        if(!$dbcon) 
        {
          ...
          $sql="Select * from feedback where feedback.id";
             ...
             <div>
              <table>
                ...
                <tr>
                  ...
                  <td><input type="text" value="<?php echo $row['quality_score'];?>" name="qlty" readonly></td>
                  <td><input type="text" value="<?php echo $row['feedback'];?>" name="fbk" readonly></td>
