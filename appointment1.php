...
input,select {
  ...
  background-color: rgb(63, 64, 65);
    ...
    <li><a href="about1.php">About Us</a></li>
        <li><a class ="contact" href="appointment1.php">Contact</a></li>
        <li><a href="bookproperty1.php">Property</a></li>
      </ul>
    </header>
        ...
        <div> 
            ...
            <a  href="login.html"><input type="button" name="confirm" value="CONFIRM" size="200" style="color: rgb(0, 0, 0);background: #ffffff;border-radius: 10px;margin-left:140px"></a>
            </fieldset></form></div>
